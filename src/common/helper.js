const iconList = {
        ...
        Arduino: {
          name: "Arduino",
          icon:
            "https://res.cloudinary.com/babyhulk/image/upload/c_scale,q_auto,w_64/v1595879735/Tech_icons/arduino.webp"
        },
        RFID: {
          name: "RFID",
          icon:
            "https://res.cloudinary.com/babyhulk/image/upload/c_scale,q_auto,w_64/v1595879814/Tech_icons/rfid.webp"
        },
        SQL: {
          name: "SQL",
          icon:
            "https://res.cloudinary.com/babyhulk/image/upload/q_auto/v1595879896/Tech_icons/sql.webp"
        }
      };
