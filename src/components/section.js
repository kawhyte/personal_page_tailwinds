		...
		<section className='max-w-6xl min-w-0 mx-auto mb-12 '>
			<div className='mx-20 mt-10  sm:mx-auto grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3'>
				<section className='m-4 rounded-lg border bg-white shadow-lg overflow-hidden'>
					<p className='text-lg sm:m-5 text-center md:text-md font-Montserrat uppercase bg-orange-200 p-1 '>Software Engineer </p>
				...
				<section className='m-4 rounded-lg border bg-white shadow-lg overflow-hidden'>
					<p className='text-lg sm:m-5 text-center md:text-md font-Montserrat uppercase bg-orange-200 p-1 '>Observational Astronomer</p>
					<div className="hidden md:block">
						<img
							alt='Man in space'
